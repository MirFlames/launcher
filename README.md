...
**На следующий день:**
- Перевести пользователей со старых лаунчеров (без автообновления) на новые — показывать предупреждение «версия устарела» (на backend уже есть учёт версий лаунчера у игроков).
- Админ-панель на отдельном закрытом порту (желательно отдельный контейнер). Для начала: отслеживание игроков — кто на какой версии лаунчера и когда последний раз заходил в игру (в читаемом виде).
