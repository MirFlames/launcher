...
var (
	buildDefaultApiBaseUrl string // API_BASE_URL — URL бэкенда (например http://62.182.138.124:58293)
	buildDefaultServerHost string // SERVER_HOST — IP/хост Minecraft-сервера
	buildDefaultServerPort string // SERVER_PORT — порт Minecraft-сервера (например 25565)
)
